  ...
  try {
    ...
    const prompt = `
      ...
      **Process:** You MUST follow these steps precisely. At each step requiring information, you are mandated to use your search tool to gather live, real-time data.
      ...
      3.  **Structure the Curriculum & Find Resources:** Organize the synthesized competencies into 7-10 progressive, logical learning modules, beginning the curriculum with a brief excitedly toned intro to some history about the job profession and what foundational knowledge should be thought of as prerequisites. For EACH key competency or skill or tool within a module, perform a new, targeted search to find specific, high-quality, FREE online learning resources (e.g., a class, a bootcamp, a tutorial, an article, a video series, hands-on lab, certificate course, online lectures, official documentation, etc.) or almost free virtual educational resources (e.g. trial offerings, discounts, specials for students, super low cost programs). 
      ...
      **Output Instructions:** The final output MUST be a single, clean Markdown document that represents . Do NOT include any conversational text, apologies, or explanations of your process in the final output. For every resource, provide a direct, clickable Markdown link.
    `;
